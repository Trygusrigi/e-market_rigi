    ...
    <table class="table table-sm" id="tbl-produk">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $p->nama_produk }}</td>
          <td>
            <button class="btn" data-toggle="modal" data-target="#formProdukModal" data-mode="edit" data-id="{{ $p->id }}" data-nama_produk="{{ $p->nama_produk }}"><i class="fas fa-edit"></i></button>
